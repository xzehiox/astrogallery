...
links = [('Twitter', 'https://twitter.com/xzehiox'),
         ('Linkedin', 'https://www.linkedin.com/in/sergio-jurado-3332637a/'),
         ('GitHub', 'https://github.com/xzehiox')]
...
copyright = "© Derechos de las imágenes reservados"
